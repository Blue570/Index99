...
signal revenue_changed(value: float)
signal active_users_changed(value: int)
signal indexed_pages_changed(value: int)
signal reputation_changed(value: float)
signal server_load_changed(value: float)

signal crawler_state_changed(is_running: bool)
signal crawler_rate_changed(value: float)
